    ...
    return (
        <div>
            ...
            <div className="relative flex flex-col  top-36 bg-black bg-opacity-90 p-12 h-[470px] w-[390px] left-[28rem] rounded-lg">
                ...
                <input ref={email} className="mb-8 text-sm text-white p-4 rounded-md bg-gray-800 bg-opacity-65" type="email" placeholder="enter your email" />

                <input ref={password} className="mb-8 text-sm text-white p-4 rounded-md bg-gray-800 bg-opacity-65" type="password" placeholder="enter password"/>
